...
public class CompactTokenListener implements TokenListener
{
    ...
    public CompactTokenListener(final PrintWriter out, long sending_time, boolean include_value_labels)
    {
    ...
    {
        group_index=0;
        printScope(RowType.groupheader);
    ...
    private void printScope(RowType row_type)
    {
        //here is where it prints the deep scope for each value.. we'd like to somehow
        out.print(row_type + ", " + message_index + ", " + group_index + ", ");
